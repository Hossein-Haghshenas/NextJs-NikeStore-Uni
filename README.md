...
در این مستندات تمام مراحل ساخت پروژه و نحوه اجرای آن و چگونگی پیاده سازی روی هاست به صورت کامل توضیح داده شده است.
...
برای پیاده سازی UI از فریمورک Tailwind css استفاده میکنیم همچنین برای آیکون های پروژه از کتابخانه heroicons استفاده میکنیم.
...
برای مختصر نوشتن کد های جاوا اسکریپتی از کتابخانه lodash استفاده میکنیم و در نهایت برای نمایش پیام ها به صورت اعلان از کتابحانه react-hot-toast استفاده خواهیم کرد.
...
در این مرحله ابتدا فونت های استفاده شده در وب سایت را از provider مورد نظر ایمپورت می کنیم و به صورت زیر در app.js قرار می دهیم.
